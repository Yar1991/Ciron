...
import firstImg from '../../img/work/band/band2.webp';
import secondImg from '../../img/work/band/band3.webp';
...
const Band = ()=> {
  ...
  return (
    <BandSection>
      <ImgBox>
        <BandImg src={firstImg} alt="microphone" variants={animImg} initial='from' animate='to'/>
      ...
      <ImgBox>
        <BandImg src={secondImg} alt="singer"/>
      </ImgBox>
    </BandSection>
  )
...
const BandSection = styled(motion.section)`
  width: 100%;
  min-height: 90vh;
`

const BandImg = styled(motion.img)`
  width: 100% ;
  height: 100% ;
  object-fit: cover;
