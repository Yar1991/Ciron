...
import firstImg from '../../img/work/live/live2.webp';
import secondImg from '../../img/work/live/live3.webp';
...
const Live = ()=> {
  ...
  return (
    <LiveSection>
      <ImgBox>
        <LiveImg src={firstImg} alt="microphone" variants={animImg} initial='from' animate='to'/>
      ...
      <ImgBox>
        <LiveImg src={secondImg} alt="singer"/>
      </ImgBox>
    </LiveSection>
  )
...
const LiveSection = styled(motion.section)`
  width: 100%;
  min-height: 90vh;
`

const LiveImg = styled(motion.img)`
  width: 100% ;
  height: 100% ;
  object-fit: cover;
